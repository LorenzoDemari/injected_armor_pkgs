...
public class OWLReferences extends OWLReferencesInterface{
     ...
     * to convert all the super classes of {@code C} as conjunctions of expressions in its definition
     * @param cl the class to be converted from equivalent expression ot sub classing
    ...
    /**
     * Given the name of a class {@code C}, it uses {@link org.semanticweb.owlapi.change.ConvertSuperClassesToEquivalentClass}
     * to convert all the super classes of {@code C} as conjunctions of expressions in its definition
     * @param className the name of aclass to be converted from equivalent expression ot sub classing
     * @return the changes to be applied in order to make all the sub axioms of a class being
     * the subclassing.
     */
